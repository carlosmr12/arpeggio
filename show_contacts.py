...
if __name__ == '__main__':
    ...
    **You must have already run your structure with Arpeggio to generate the required output files**.
    ...
    # GET CONTACTS
    with open(contacts_filename, 'r') as fo:
    ...
    # RING CENTROIDS
    with open(rings_filename, 'r') as fo:
        for line in fo:
            line = line.strip().split('\t')
    ...
    with open(ari_filename, 'r') as fo:
        for line in fo:
            line = line.strip().split('\t')
    ...
    with open(amri_filename, 'r') as fo:
        for line in fo:
            line = line.strip().split('\t')
    ...
    with open(amam_filename, 'r') as fo:
        for line in fo:
            line = line.strip().split('\t')
    ...
    if args.script:
        with open(script_filename, 'w') as fo:
